          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-2">
              <div className="relative w-[46px] h-[46px]">
                <Image src="/images/logo.png" alt="DailyDilli" fill className="object-contain" />
              </div>
              <span className="text-2xl md:text-3xl font-extrabold text-black">DailyDilli</span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                <div className="relative w-[32px] h-[32px]">
                  <Image src="/images/logo.png" alt="DailyDilli Logo" fill className="object-contain" />
                </div>
